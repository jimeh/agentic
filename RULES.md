...
- Lead with why over what. The diff shows what changed; the message should
  explain the motivation and purpose behind the change. If the reason is not
...
- PR descriptions should lead with the motivation and purpose behind the change
